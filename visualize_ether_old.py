...
def generate_interactive_html(f_history, frames_data, output_path):
    print("Generating 3D interactive HTML for Diethyl Ether (Old Simulator)...")
    frames = []
    ...
    fig = go.Figure(
        ...
        layout=go.Layout(
            title=dict(text="Diethyl Ether Trajectory (Original Old Simulator - Full System)", font=dict(color='white', size=18)),
...
if __name__ == "__main__":
    ...
    output_file = "/home/eldenring/waterMain/diethyl_ether_old_simulation.html"
