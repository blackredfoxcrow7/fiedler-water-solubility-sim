...
def run_fiedler_opt_sim(G_init, w_os, steps=100, allow_long_distance_water=False):
    ...
    for t in range(steps):
        ...
        # --- フェーズ3: 疎水性凝集 ---
        # 修正前のコード：無制限に引き合い、重みも等しいため強力に潰れて密な油滴となる
        if t >= 30:
...
if __name__ == "__main__":
    smiles_list = ["CC(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](CCCCN)C(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](CCCCN)C(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](CCCCN)C(N)=O"]#["CC(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](CCCCN)C(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](CCCCN)C(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](C)C(=O)N[C@@H](CCCCN)C(N)=O"] #"CCC(O)C" "N[C@@H](C)C(=O)O"  Leu-Ser-Leu-Ser-Leu "CC(C)C[C@@H](N)C(=O)N[C@@H](CO)C(=O)N[C@@H](CC(C)C)C(=O)N[C@@H](CO)C(=O)N[C@@H](CC(C)C)C(=O)O"
    print(smiles_list)
